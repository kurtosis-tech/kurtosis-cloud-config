...
retry 10 wget https://amazoncloudwatch-agent.s3.amazonaws.com/ubuntu/amd64/latest/amazon-cloudwatch-agent.deb
retry 10 dpkg -i -E ./amazon-cloudwatch-agent.deb
